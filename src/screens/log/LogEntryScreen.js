      ...
      {[45, 63, 81, 99].map((y, i) => (
        <G key={i}>
          <Rect
            ...
            height="10"
            rx="2.5"
            fill={i < 2 ? ACCENT : "#e8f5f2"}
            stroke={ACCENT}
            strokeWidth="1.5"
          />
          {i < 2 && (
            <Path
              d={`M${69} ${y + 5} L${72} ${y + 8} L${75} ${y + 2}`}
              stroke="#fff"
              strokeWidth="1.5"
              strokeLinecap="round"
...
function IllustrationCravings() {
  return (
    <Svg width={180} height={160} viewBox="0 0 200 180" fill="none">
      ...
      />
      <Path
        d="M70 65 Q80 55 90 65 Q100 75 110 65 Q120 55 130 65"
        stroke={ACCENT}
        strokeWidth="2"
        fill="none"
        strokeLinecap="round"
      ...
      />
      <Path
        d="M75 80 Q85 70 95 80 Q105 90 115 80 Q125 70 130 80"
        stroke={ACCENT}
        strokeWidth="2"
        fill="none"
        strokeLinecap="round"
      ...
      />
      <Path
        d="M30 135 Q45 120 60 135 Q75 150 90 135 Q105 120 120 135 Q135 150 150 135 Q165 120 170 128"
        stroke={ACCENT}
        strokeWidth="3"
        fill="none"
        strokeLinecap="round"
        opacity="0.4"
      />
      {["#22C55E", "#7AABDB", "#FBBF24", "#FB923C", "#EF4444", "#991B1B"].map(
        (c, i) => (
...
function IllustrationSideEffects() {
  return (
    <Svg width={180} height={160} viewBox="0 0 200 180" fill="none">
      ...
      />
      <Path
        d="M72 85 Q65 100 68 130 L100 135 L132 130 Q135 100 128 85 Q114 75 100 78 Q86 75 72 85 Z"
        fill="#e8f5f2"
        stroke={ACCENT}
        strokeWidth="2"
      />
      {[
        ...
        <G key={i}>
          <Circle
            ...
            cy={y + 12}
            r="18"
            fill={["#fef3c7", "#dbeafe", "#fce7f3", "#dcfce7", "#ffedd5"][i]}
            stroke={["#D97706", "#3B82F6", "#EC4899", "#22C55E", "#F97316"][i]}
            strokeWidth="1.5"
          />
        </G>
      ))}
...
function IllustrationWeight() {
  return (
    <Svg width={180} height={160} viewBox="0 0 200 180" fill="none">
      ...
      />
      <Polyline
        points="40,75 60,60 80,65 100,45 120,50 140,30 160,35"
        stroke={ACCENT}
        strokeWidth="3"
        fill="none"
        strokeLinecap="round"
...
export default function LogEntryScreen({ navigation, route }) {
  ...
  const [weight, setWeight] = useState(
    existingLog?.weight ? String(existingLog.weight) : "",
  );
  const [medsTaken, setMedsTaken] = useState(
    existingLog?.medicationsTaken ?? [],
  );
  ...
  const toggleMed = (med) => {
    setMedsTaken((prev) => {
      ...
      return [
        ...prev,
        { id: med._id, name: med.name, dosage: med.dosage ?? "" },
      ];
    });
  };
  ...
  const STEPS = [
    ...
    },
    {
      ...
      content: (
        <Chips
          ...
          onToggle={(v) => toggle(setSideEffects, v)}
          labelFn={(v) => t[v] ?? v}
        />
      ),
    },
    {
      ...
      subtitle:
        t.medicationsSubtitle ?? "Which medications did you take today?",
        ...
        <View style={{ gap: 10 }}>
          {savedMeds.length === 0 ? (
            <View style={{ alignItems: "center", paddingVertical: 20 }}>
              ...
              >
                {t.noMedsSaved ??
                  "No medications saved yet. Add them in the Medications screen."}
              </Text>
            </View>
          ) : (
            savedMeds.map((med) => {
                ...
                >
                  ...
                  >
                    ...
                    <View style={{ flex: 1 }}>
                      ...
                      {med.dosage ? (
                        <Text
                          style={{ color: TEXT_MUTED, fontSize: FontSize.sm }}
                        >
                          {med.dosage}
                        </Text>
                      ) : null}
                  ...
                  {active && (
                    ...
                    >
                      <TextInput
                        ...
                        placeholder={
                          t.dosageTaken ?? "Dosage taken today (e.g. 8mg)"
                        }
