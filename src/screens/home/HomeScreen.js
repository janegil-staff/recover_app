...
function IconCraving({ color, size = 32 }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 32 32" fill="none">
      <Path
        d="M16 4 C16 4 8 10 8 18 C8 22.4 11.6 26 16 26 C20.4 26 24 22.4 24 18 C24 10 16 4 16 4 Z"
        stroke={color}
        strokeWidth="2"
        fill="none"
        strokeLinejoin="round"
...
function IconWellbeing({ color, size = 32 }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 32 32" fill="none">
      <Path
        d="M16 27 C16 27 5 19 5 12 C5 8.1 8.1 5 12 5 C14 5 15.8 5.9 17 7.3 C18.2 5.9 20 5 22 5 C25.9 5 29 8.1 29 12 C29 19 16 27 16 27 Z"
        stroke={color}
        strokeWidth="2"
        fill="none"
        strokeLinejoin="round"
...
function IconMyData({ color, size = 46 }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 48 48" fill="none">
      ...
      />
      <Polyline
        points="6,36 16,28 26,32 36,18 44,12"
        stroke={color}
        strokeWidth="2.5"
        strokeLinecap="round"
        strokeLinejoin="round"
        ...
        >
          <View style={[s.logBtnInner, { backgroundColor: theme.accent }]}>
            <Text style={s.logBtnText}>
              {todayLog ? `✏️  ${t.editToday}` : `📋  ${t.logToday}`}
            </Text>
          </View>
        </TouchableOpacity>
      </View>
...
const makeStyles = (t, insets = { top: 44 }) =>
  StyleSheet.create({
